# Generated by Django 2.0.7 on 2018-08-06 00:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('food_spicy', models.IntegerField(choices=[(-3, 'must not have'), (-2, 'really do not like'), (-1, 'do not like'), (0, 'have no preference over'), (1, 'like'), (2, 'really like'), (3, 'must have')], default=0)),
                ('food_vegan', models.IntegerField(choices=[(-3, 'must not have'), (-2, 'really do not like'), (-1, 'do not like'), (0, 'have no preference over'), (1, 'like'), (2, 'really like'), (3, 'must have')], default=0)),
                ('food_vegetarian', models.IntegerField(choices=[(-3, 'must not have'), (-2, 'really do not like'), (-1, 'do not like'), (0, 'have no preference over'), (1, 'like'), (2, 'really like'), (3, 'must have')], default=0)),
                ('place_loud', models.IntegerField(choices=[(-3, 'must not have'), (-2, 'really do not like'), (-1, 'do not like'), (0, 'have no preference over'), (1, 'like'), (2, 'really like'), (3, 'must have')], default=0)),
            ],
        ),
        migrations.CreateModel(
            name='Snippet',
        ...
        migrations.AddField(
            model_name='foodcategoryliked',
            name='preferences',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Preferences'),
        ),
        migrations.AddField(
            model_name='foodcategorydisliked',
            name='preferences',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Preferences'),
        ),
    ]
